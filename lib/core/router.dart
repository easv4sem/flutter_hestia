  ...
  static final GoRouter router = GoRouter(
    ...
    redirect: devMode
        ...
        : (context, state) {
            ...
            if (!loggedIn && !(isOnLogin || isOnRegister || isOnLandingPage)) {
    ...
    routes: [
      GoRoute(path: Routes.home.path, builder: (context, _) => const HomePage()),
      GoRoute(path: Routes.settings.path, builder: (context, _) => const SettingsPage()),
      GoRoute(path: Routes.cookies.path, builder: (context, _) => const CookiesPage()),
      GoRoute(path: Routes.privacy.path, builder: (context, _) => const PrivacyPolicyPage()),
      GoRoute(path: Routes.landingPage.path, builder: (context, _) => const LandingPage()),
      GoRoute(path: Routes.login.path, builder: (context, _) => const LoginPage()),
      GoRoute(path: Routes.registre.path, builder: (context, _) => const RegistrePage()),
    ],
  );
}
